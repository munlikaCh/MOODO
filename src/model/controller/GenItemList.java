...
//-------1.31
        public static ArrayList<BasedEquipment> setUpItemList() {
            ...
            itemLists.add(new Weapon("Sword",10, DamageType.magical,"assets/Smile.png"));
            itemLists.add(new Weapon("Gun",20,DamageType.magical,"assets/Boring.png"));
            itemLists.add(new Weapon("Staff",30,DamageType.magical,"assets/Panic.png"));
            //++Bow++
            itemLists.add(new Weapon("Bow", 100,  DamageType.magical, "assets/Love.png"));
            //=======
            itemLists.add(new Armor("shirt",0,50,"assets/Sad.png"));
            itemLists.add(new Armor("armor",50,0,"assets/Angry.png"));
            //++defense++
